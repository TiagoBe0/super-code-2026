#!/usr/bin/env python3
"""
CLI para Alpha Shape: Detección de superficie con Ghost Particles
"""
...
from unified_md_analysis.core.surface_detection import AlphaShapeWithGhosts
...
def main():
    parser = argparse.ArgumentParser(
        description="Alpha Shape: Detección de superficie con Ghost Particles",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Ejemplos:
  # Uso básico
  python alpha_shape.py input.dump output.dump

  # Con parámetros personalizados
  python alpha_shape.py input.dump output.dump --probe-radius 2.2 --num-ghost-layers 3

  # Con suavizado
  python alpha_shape.py input.dump output.dump --smoothing 10
        """
    )
    ...
    print(f"\n{'='*80}")
    print(f"{'ALPHA SHAPE: DETECCIÓN DE SUPERFICIE':^80}")
    print(f"{'='*80}\n")
